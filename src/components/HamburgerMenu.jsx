...
function HamburgerMenu () {
  ...
  return (
    <div className='md:hidden'>
      ...
      {modalOpen && (
        <div className='mt-28 fixed inset-0 px-10 bg-gradient-to-b from-gray-50 to-black/50'>
          <div className='flex flex-col items-center justify-between mt-4 mx-auto h-64 w-full text-DarkBlue font-bold bg-VaryLightGray p-6 rounded-md'>
            <a href='#'>Pricing</a>
            <a href='#'>Product</a>
            <a href='#'>About Us</a>
            <a href='#'>Careers</a>
